    ...
    <form action="#" @submit.prevent="login" class="mb-8">
      <div class="mb-6">
        <div class="mb-3">
          ...
          <input
              type="text" id="email" class="w-full border-2 border-gray-200 h-10 px-3 rounded-md"
              v-model="form.email"
          >
        </div>
        <div class="mb-3">
          ...
          <input
              type="password" id="password" class="w-full border-2 border-gray-200 h-10 px-3 rounded-md"
